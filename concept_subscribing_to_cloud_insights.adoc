...
根据所用节点是高端节点、中端节点还是入门级节点、在以下受管单元(Managed Unit、MU)计数下计量工作负载安全性：
...
| 1个高端节点 | 700、800、900、9xxx | 80个托管单元 


| 1个中端节点 | 300、400、500、8x00 | 40个托管单元 


| 1个入门级节点 | 1xx、2xx、2xxx | 20个托管单元 


| 1软件ONTAP | CVO、FSx | 10个托管单元 
