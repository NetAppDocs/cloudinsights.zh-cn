...
| 启用 Cloud Secure 后， ONTAP 性能将受到影响：延迟偶尔会高， IOPS 偶尔会低。 | 确保您使用的是 Data ONTAP 版本，其中 link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1415152["此问题描述"] 已修复。建议的 ONTAP 最低版本为 9.8P7 。 
