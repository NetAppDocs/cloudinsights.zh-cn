...
| 操作系统 | 运行以下许可版本之一的计算机：Red Hat Enterprise Linux 7.x、8.x 64位CentOS 7.x 64位CentOS 8 Stream Ubuntu 20到22 64位此计算机不应运行任何其他应用程序级软件。建议使用专用服务器。 
...
| 可用磁盘空间 | 应按以下方式分配磁盘空间：/opt/netapp 35 GB (最小) 
