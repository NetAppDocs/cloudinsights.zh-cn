...
|  | skipLocked.内存 | 请参见此内容 link:https://community.influxdata.com/t/updating-telegraf-to-version-1-29-5-crashes-kubernetes-pod/33376["已知电报问题描述"]。  设置skipLocked. Memory将指示Kubelnetes监控操作员使用运行Telegraf `--unprotected` 标志。 
