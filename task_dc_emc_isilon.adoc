...
summary: 配置 Dell EMC Isilon 数据收集器。 
---
= Dell EMC Isilon 数据收集器


[role="lead"]
Cloud Insights 使用 Isilon SSH 数据收集器从 EMC Isilon 横向扩展 NAS 存储获取清单和性能数据。



== 术语

Cloud Insights 从 Isilon 数据收集器采集以下清单信息。对于 Cloud Insights 收购的每种资产类型，均显示了此资产最常用的术语。查看此数据收集器或对其进行故障排除时，请记住以下术语：
